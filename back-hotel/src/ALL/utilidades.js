...
import ModalReserva from './ModalReserva'; // Certifique-se de que o arquivo está na mesma pasta
...
const HomePage = () => {
    ...
    useEffect(() => {
        // Sincronia com LoginUser: Busca dados do localStorage
        ...
        <div style={styles.container}>
            ...
            <aside style={styles.sidebar}>
                ...
                <nav style={styles.nav}>
                    ...
                    <button style={styles.navItem} onClick={() => navigate('/quartos')}>
                        🛏️ Ver Quartos
                    </button>
                    ...
                    {user.tipo === 'FUNCIONARIO' && (
                        <>
                            <button style={styles.navItem} onClick={() => navigate('/cadastrar-quarto')}>
                                ➕ Novo Quarto
                            </button>
